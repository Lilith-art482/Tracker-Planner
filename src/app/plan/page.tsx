        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-xl bg-slate-800 border border-white/10 p-6 shadow-2xl">
            ...
            <div className="flex justify-end gap-2 mt-5">
              ...
              >
                {submitting ? <span className="flex items-center gap-1.5"><span className="w-3.5 h-3.5 border-2 border-white/30 border-t-white rounded-full animate-spin" />Сохранение...</span> : (editingItem ? "Обновить" : "Создать")}
              </button>
            </div>
          </div>
        </div>
